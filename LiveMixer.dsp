...
// gui
slider = vslider("[3]Volume", 1, 0, 1, 0.01) : smooth(0.999);
send1 = vslider("[1]Send A[style:knob]", 1, 0, 1, 0.01) : smooth(0.999);
send2 = vslider("[2]Send B[style:knob]", 1, 0, 1, 0.01) : smooth(0.999);
